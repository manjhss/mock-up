...
import { Pacifico, Sedan, Pixelify_Sans } from "next/font/google";
...
export const pixelSquare = Pixelify_Sans({
...
export const font = ["font-pacifico", "font-sedan", "font-pixelify-sans"];
export const border = [
  "shadow-xl", // Default
